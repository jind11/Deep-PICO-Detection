...
def Config(load=True):
    ...
    parser.add_argument('--data_keyname', required=True, type=str,
                help='directory for output')
    parser.add_argument('--filename_wordvec_trimmed', default='',
    ...
    if args.data_keyname == 'pico':
        ...
        args.filename_dev = os.path.join(args.data_root, 'test.txt')
        args.filename_test = os.path.join(args.data_root, 'test.txt')
        args.filename_train = os.path.join(args.data_root, 'train.txt')
    ...
    args.filename_wordvec_trimmed = os.path.join('data', args.data_keyname, 'word.embeddings.trimmed.txt')
